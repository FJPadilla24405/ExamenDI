...
import utils.login.ControladorInicioSesión;
...
public class InicioSesión extends JFrame {
	...
	private static InicioSesión frame;
	...
	public InicioSesión() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(InicioSesión.class.getResource("/resources/logo.png")));
		setTitle("iSalud");
		...
		lblNewLabel.setIcon(new ImageIcon(InicioSesión.class.getResource("/resources/logo.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(InicioSesión.class.getResource("/resources/imgPortada.png")));
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ControladorInicioSesión.login(textEmail.getText(), textPsswrd.getText())) {
					new MainScreen();
